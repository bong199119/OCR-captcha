...
def main():
    ...
    if WEIGHT:        
        ...
        for batch in test_dataset.take(len(list_test_png)):
            ...
            # 매핑
            # dict_map = {'1':'5', '2':'2', '3':'0', '4':'3', '5':'1',
            #             '6':'8', '7':'4', '8':'7', '9':'6', '0':'9'
            #             }
            # converted_letter = ''
            # for ele in pred_texts[0]:
            #     converted_letter += dict_map[ele]

            # plt.title(converted_letter)
            # plt.savefig(os.path.join(RESULTS_DIR,'{}.png'.format(converted_letter)))
            # print(pred_texts[0], 'saved')
            # print(converted_letter, 'saved')
            # print('-------------------')
            # plt.close()
            #
